...
/*
const errorLogger = (errorNumber,errorMessage)=>{
    console.error(`Error ${errorNumber}: ${errorMessage}`);
};
const bindToLogger = (object)=>{
    for(let key of object)
    {
        key=errorLogger.bind(key);
    }
};

const { e400, e403 } = ctx.errors;
e400('You are not allowed to upload files with this extension');
*/
